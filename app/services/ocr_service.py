...
def perform_ocr_on_crops_and_export(cropped_images_dir: str, output_excel_path: str, pdf_path: str, reference_text: str,
                                    reference_page: int):
    ...
    if ocr_results:
        ...
        # ✨ 엑셀 열 순서를 명확하게 지정
        column_order = ["PID NO", "Original Page", "Cropped Filename", "Class Name", "Detection Score",
                        "Recognized Text"]
        df = df[column_order]
